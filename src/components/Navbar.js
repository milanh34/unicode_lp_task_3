...
<nav className="bg-gray-800 border-gray-700">
  <div className="max-w-screen-xl mx-auto p-4">
    <div className="w-full flex justify-between items-center" id="navbar-solid-bg">
          <Link to="/home" className="py-2 px-3 text-sky-500 rounded hover:bg-sky-900 hover:text-white flex font-medium mt-4 rtl:space-x-reverse flex-row border-gray-700" aria-current="page">Home</Link>
